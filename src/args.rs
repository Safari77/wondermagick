...
impl Arg {
    ...
    pub fn help_text(&self) -> &'static str {
        match self {
            ...
            Arg::Quantize => "reduce colors (format: colors,dither_level,bias | e.g., '16,1.0,0.0', '32,0.2,0.2:2.6', or 'default' — bias < 0.0 uses Oklab median-cut, 0.0 uses RGB K-means, >0.0 uses Oklab K-means++ (supports optional light_boost parameter)",
